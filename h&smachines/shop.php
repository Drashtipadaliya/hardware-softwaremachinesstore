...
<div class='col-md-15 '>
	...
	<div class="container">
	  ...
	  <div class="row no-gutters slider-text align-items-center justify-content-center">
		...
		<h1 class="mb-0 bread">SHOPPING</h1> 	
...
<div class="col-md-15 ">
	...
	<div class="row border-red">
		...
		<?php
			include"config.php";
			$r=mysqli_query($con,"select * from product where catgry='".$_REQUEST['cat']."'");
...
//
	//		if($check_page === "laptop")
		...
		//	{
			...
			<h3 class="card-title fw-bold text-dark fs-1"> <?php echo $row['pname'];?></h3>
			<input type="hidden"  name="pname" value="<?php echo $row['pname'];?>">
			<div class="pricing py-1 mr-0 " >
			<p class="card-title fw-bold text-dark fs-1"> RS:<?php echo $row['price'];?>
			<input type="hidden"  name="price" value="<?php echo $row['price'];?>">
			</p>
			
			
			
			<p class="card-title fw-bold text-dark fs-1"> QUENTY:<?php echo $row['qnty'];?>
			</div>
			</div> 
