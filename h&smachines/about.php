			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/about.jpg);">
						<a href="../img/y2mate.com - Technology I  Vocabulary for Kids  Laptop monitor mouse speakers webcam microphone_1080p.mp4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="pb-md-5 pb-4">
							...
							<p><a href="display.php" class="btn btn-primary">Shop now</a></p>
						</div>
					</div>
				</div>
			</div>
